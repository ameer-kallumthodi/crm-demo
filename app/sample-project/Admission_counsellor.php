...
class Admission_counsellor extends AppBaseController
{
    private $users_model;
    ...
    public function index(){
        $this->data['list_items'] = $this->users_model->get(['role_id' => 12])->getResultArray();
        $this->data['page_title'] = 'Admission Counsellor';
        $this->data['page_name'] = 'Admission_counsellor/index';
        return view('App/index', $this->data);
    }
    
    public function ajax_add(){
        $this->data['country_code'] = get_country_code();
        echo view('App/Admission_counsellor/ajax_add', $this->data);
    }
    ...
    public function add(){
        ...
        return redirect()->to(base_url('app/admission_counsellor/index'));
    }
    
    public function ajax_edit($id){
        $this->data['country_code'] = get_country_code();
        $this->data['edit_data'] = $this->users_model->get(['id' => $id])->getRowArray();
        echo view('App/Admission_counsellor/ajax_edit', $this->data);
    }
    ...
    public function ajax_view($id){
        ...
        echo view('App/Admission_counsellor/ajax_view', $this->data);
    }
