...
class Admin extends AppBaseController
{
    ...
    public function ajax_add(){
        ...
        echo view('App/Admin/ajax_add', $this->data);
    }
    ...
    public function add(){
        ...
        return redirect()->to(base_url('app/admin/index'));
    }
    
    public function ajax_edit($id){
        $this->data['country_code'] = get_country_code();
        $this->data['edit_data'] = $this->users_model->get(['id' => $id])->getRowArray();
        echo view('App/Admin/ajax_edit', $this->data);
    }
    ...
    public function ajax_view($id){
        ...
        echo view('App/Admin/ajax_view', $this->data);
    }
