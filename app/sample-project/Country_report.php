...
class Country_report extends AppBaseController
{
    ...
    public function index(){
        ...
        $country_list = $this->country_model->get()->getResultArray();
        $this->data['countries'] = array_column($country_list,'title','id');
        ...
        $this->data['page_title'] = 'Country Report';
        $this->data['page_name'] = 'Country_report/index';
