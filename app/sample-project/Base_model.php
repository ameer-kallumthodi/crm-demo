...
class Base_model extends Model
{
    ...
    public function get($where = null, $select = null, $order_by = null, $limit = null, $group_by = null)
    {
        ...
        if ($where != null) {
            if (isset($where['OR'])) {
                ...
                unset($where['OR']); // Remove OR from the main where array
    ...
    public function get_join($joins, $where = [], $select = [], $order_by = null)
    {
        $query = $this->db->table($this->table);
        ...
        if ($order_by != null) {
            $query->orderBy($order_by['key'], $order_by['direction']);
        }
