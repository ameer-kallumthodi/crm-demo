                                ...
                                foreach ($list_items as $key => $list_item){ 
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="<?= base_url('app/voxbay_calllogs/list/'. $list_item['id']) ?>" class="btn btn-sm btn-info">
...
function makeCall(phoneNumber, lead_id) {
    const telecaller_id = <?= get_user_id() ?>;

    $.ajax({
        url: "<?= base_url('app/voxbay/outgoingcall') ?>",
        method: "POST",
        ...
        success: function(response) {
            ...
            if (response.status === 'success') {
                ...
                console.warn('Server responded with error:', response.message);
            }
        },
