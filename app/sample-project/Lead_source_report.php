...
class Lead_source_report extends AppBaseController
{
    private $users_model;
    private $leads_model;
    ...
    public function index(){
        ...
        foreach ($this->data['list_items'] as $lead) {
        ...
        $this->data['total_count'] = count($this->data['list_items']);
        $this->data['page_title'] = 'Lead Source Report';
        $this->data['page_name'] = 'Lead_source_report/index';
