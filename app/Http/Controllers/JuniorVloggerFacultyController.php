...
class JuniorVloggerFacultyController extends Controller
{
    ...
    {
        if (!RoleHelper::is_admin_or_super_admin() && !RoleHelper::is_admission_counsellor() && !RoleHelper::is_faculty() && !RoleHelper::is_telecaller() && !RoleHelper::is_team_lead() && !RoleHelper::is_senior_manager() && !RoleHelper::is_hod() && !RoleHelper::is_academic_assistant()) {
