...
class LeadGraphicDesigningRegistrationController extends Controller
{
    public function showGraphicDesigningForm($leadId = null)
    {
        ...
        if ($leadId) {
            ...
            if ($lead && $lead->graphicDesigningStudentDetails) {
                return view('public.graphic-designing-registration-success');
            }
        }
        ...
        return view('public.graphic-designing-registration', compact('subjects', 'batches', 'lead', 'countryCodes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return response()->json([
                ...
                'data' => $studentDetail,
                'redirect' => route('public.lead.graphic-designing.register', $request->lead_id)
            ]);
