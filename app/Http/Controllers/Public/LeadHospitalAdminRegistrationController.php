...
{
    public function showHospitalAdminForm($leadId = null)
    {
        ...
        if ($leadId) {
            ...
            if ($lead && $lead->hospitalAdminStudentDetails) {
                return view('public.hospital-admin-registration-success');
            }
        }
        ...
        return view('public.hospital-admin-registration', compact('subjects', 'batches', 'lead', 'countryCodes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            try {
                ...
                // Log error but don't fail the registration
                \Log::error('Failed to create lead activity for Hospital Admin registration: ' . $e->getMessage());
            }
            ...
            return response()->json([
                ...
                'data' => $studentDetail,
                'redirect' => route('public.lead.hospital-admin.register.success', $request->lead_id)
            ]);
