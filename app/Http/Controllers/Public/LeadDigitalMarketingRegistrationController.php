...
{
    public function showDigitalMarketingForm($leadId = null)
    {
        ...
        if ($leadId) {
            ...
            if ($lead) {
                ...
                if ($studentDetail) {
                    return view('public.digital-marketing-registration-success');
                }
            }
        }
        ...
        return view('public.digital-marketing-registration', compact('subjects', 'batches', 'lead', 'countryCodes', 'classTimes', 'course', 'offlinePlaces'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return response()->json([
                ...
                'data' => $studentDetail,
                'redirect' => route('public.lead.digital-marketing.register', $request->lead_id)
            ]);
