...
class LeadBosseRegistrationController extends Controller
{
    public function showBosseForm($leadId = null)
    {
        ...
        if ($leadId) {
            ...
            if ($lead && $lead->bosseStudentDetails) {
        ...
        return view('public.bosse-registration', compact('subjects', 'batches', 'lead', 'countryCodes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return response()->json([
                ...
                'data' => $studentDetail,
                'redirect' => route('public.lead.bosse.register', $request->lead_id)
            ]);
