...
<head>
    ...
    <title>TTC Course Registration</title>
...
<body style="background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%); min-height: 100vh; padding: 20px 0;">
    <div class="wizard-container">
        <div class="wizard-header">
            ...
            <h2><i class="fas fa-chalkboard-teacher me-2"></i>TTC Course Registration</h2>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
     <script>
         let currentStep = 1;
         const totalSteps = 3;
         const STORAGE_KEY = 'ttc_form_data';
        ...
        document.getElementById('registrationForm').addEventListener('submit', function(e) {
            ...
            fetch('{{ route("public.lead.ttc.register.store") }}', {
                method: 'POST',
                body: formData,
                headers: {
