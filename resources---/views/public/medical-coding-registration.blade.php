...
<head>
    ...
    <title>Medical Coding Course Registration</title>
...
<body style="background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%); min-height: 100vh; padding: 20px 0;">
    <div class="wizard-container">
        <div class="wizard-header">
            <div class="logo-container mb-3">
                <img src="{{ asset('storage/skill-park-logo.png') }}" alt="Skill Park Logo" class="skill-park-logo">
            </div>
            <h2><i class="fas fa-stethoscope me-2"></i>Medical Coding Course Registration</h2>
            ...
            <form id="registrationForm" enctype="multipart/form-data" novalidate>
                ...
                <div class="form-step" id="formStep3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Plus Two Certificate <span class="required">*</span></label>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
     <script>
         let currentStep = 1;
         const totalSteps = 3;
         const STORAGE_KEY = 'medical_coding_form_data';
        ...
        document.getElementById('registrationForm').addEventListener('submit', function(e) {
            ...
            fetch('{{ route("public.lead.medical-coding.store") }}', {
                method: 'POST',
                body: formData,
                headers: {
