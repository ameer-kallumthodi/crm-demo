<div class="container p-2">
    <form id="countryAddForm" action="{{ route('admin.countries.submit') }}" method="post">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="mb-3">
    ...
    $('#countryAddForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                toast_success('Country created successfully!');
            ...
            error: function(xhr) {
                let errorMessage = 'An error occurred while creating the country.';
