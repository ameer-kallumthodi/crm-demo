<div class="container p-2">
    <form id="subjectEditForm" action="{{ route('admin.subjects.update', $edit_data->id) }}" method="post">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-md-12">
                <div class="mb-3">
                    <label class="form-label" for="title">Subject Title <span class="text-danger">*</span></label>
                    <input type="text" name="title" class="form-control" id="title" value="{{ $edit_data->title }}" placeholder="Enter Subject Title" required>
                </div>
            </div>
    ...
    $('#subjectEditForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                toast_success('Subject updated successfully!');
