...
<body>
    <div class="header">
        <h2 style="margin: 0;">📋 Support Feedback Update</h2>
        <p style="margin: 10px 0 0 0; opacity: 0.9;">Here are the latest details we recorded</p>
    </div>
    
    <div class="content">
        <div class="student-info">
            <h3 class="section-heading">Your Enrollment Details</h3>
    ...
    <div class="footer">
        <p style="margin: 0;"><strong>This is an automated update from our support team.</strong></p>
        <p style="margin: 5px 0 0 0;">Submitted by: {{ $feedback->createdBy?->name ?? 'Support Team' }} on {{ $feedback->created_at?->format('d M Y, H:i A') ?? 'N/A' }}</p>
    </div>
</body>
</html>
