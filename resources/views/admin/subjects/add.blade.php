<div class="container p-2">
    <form id="subjectAddForm" action="{{ route('admin.subjects.submit') }}" method="post">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="mb-3">
    ...
    $('#subjectAddForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                toast_success('Subject created successfully!');
            ...
            error: function(xhr) {
                let errorMessage = 'An error occurred while creating the subject.';
