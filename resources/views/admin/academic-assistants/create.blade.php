        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Add Academic Assistant</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('academic-assistants.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">Create Academic Assistant</button>
                        </div>
                    </form>
                </div>
            </div>
