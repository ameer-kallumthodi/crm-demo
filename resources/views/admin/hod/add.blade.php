<div class="container p-2">
    <form id="hodAddForm" action="{{ route('admin.hod.submit') }}" method="post">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="department_id" name="department_id">
                        ...
                        @foreach($departments as $id => $title)
                            <option value="{{ $id }}" {{ old('department_id') == $id ? 'selected' : '' }}>{{ $title }}</option>
                        @endforeach
                    </select>
...
<script>
document.getElementById('hodAddForm').addEventListener('submit', function(e) {
    e.preventDefault();
