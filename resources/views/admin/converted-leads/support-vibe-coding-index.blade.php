        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="page-header-title">
                    <h5 class="m-b-10">Vibe Coding Converted Support List</h5>
                </div>
            </div>
            <div class="col-md-6">
                <div class="d-flex justify-content-end align-items-center gap-3">
                    <ul class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item">Vibe Coding Converted Support List</li>
                    </ul>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex gap-2 flex-wrap">
                    ...
                    <a href="{{ route('admin.support-vibe-coding-converted-leads.index') }}" class="btn btn-outline-primary active">
...
<div class="row mb-3">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="GET" action="{{ route('admin.support-vibe-coding-converted-leads.index') }}" id="filterForm">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5>Vibe Coding Converted Support List</h5>
            </div>
            <div class="card-body">
                <!-- Desktop Table View -->
                <div class="d-none d-lg-block">
                    <div class="table-responsive">
                        <table class="table table-hover data_table_basic" id="supportVibeCodingTable">
                        <thead>
                            <tr>
                                <th>SL No</th>
...
#supportVibeCodingTable thead th,
#supportVibeCodingTable tbody td {
    white-space: nowrap;
}
...
#supportVibeCodingTable tbody tr:hover {
    background: #fafbff;
}

#supportVibeCodingTable td .display-value {
    display: inline-block;
    max-width: 220px;
    overflow: hidden;
    text-overflow: ellipsis;
...
#supportVibeCodingTable .btn-group .btn { margin-right: 4px; }
#supportVibeCodingTable .btn-group .btn:last-child { margin-right: 0; }
</style>
@endpush
...
<script>
    $(document).ready(function() {
        ...
        $(document).off('click.saveInline').on('click.saveInline', '.save-edit', function(e) {
            ...
            $.ajax({
                url: `/admin/support-vibe-coding-converted-leads/${id}/update-support-details`,
                method: 'POST',
                data: {
                    field: field,
                    value: value,
        ...
        function loadSubjectsForEdit($select, currentValue) {
            $.get('/api/subjects/by-course/14').done(function(list) {
