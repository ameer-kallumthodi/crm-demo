...
@section('title', 'Eduthanzeel Converted Faculty List')
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="page-header-title">
                    <h5 class="m-b-10">Eduthanzeel Converted Faculty List</h5>
                </div>
            </div>
            <div class="col-md-6">
                <ul class="breadcrumb d-flex justify-content-end">
                    ...
                    <li class="breadcrumb-item">Eduthanzeel Faculty</li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="row mb-3">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="GET" action="{{ route('admin.faculty-eduthanzeel-converted-leads.index') }}" id="filterForm">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-12 col-sm-6 col-md-2">
                            ...
                            <a href="{{ route('admin.faculty-eduthanzeel-converted-leads.index') }}" class="btn btn-secondary">
...
<div class="row">
    <div class="col-12">
        <div class="card" data-mentor-update-url="{{ route('admin.faculty-eduthanzeel-converted-leads.update-mentor-details', ['id' => '__ID__']) }}">
            <div class="card-header">
                <h5>Eduthanzeel Converted Faculty List</h5>
            </div>
            <div class="card-body">
                <!-- Desktop Table View -->
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover data_table_basic" id="eduthanzeelMentorTable">
                            ...
                            <tbody>
                                ...
                                @empty
                                <tr>
                                    <td colspan="35" class="text-center">No Eduthanzeel converted leads found for mentoring</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
    ...
    $(document).ready(function() {
        ...
        $(document).off('click.saveInline').on('click.saveInline', '.save-edit', function(e) {
            ...
            const updateUrl = isConvertedLeadField ?
                ...
                `/admin/faculty-eduthanzeel-converted-leads/${id}/update-mentor-details`;
...
@include('admin.converted-leads.partials.course-flag-inline-scripts', ['courseUpdateUrl' => route('admin.faculty-eduthanzeel-converted-leads.update-mentor-details', ['id' => '__ID__'])])
@endpush