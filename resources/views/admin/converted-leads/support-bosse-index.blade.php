        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="page-header-title">
                    <h5 class="m-b-10">Bosse Converted Support List</h5>
                </div>
            </div>
            <div class="col-md-6">
                <div class="d-flex justify-content-end align-items-center gap-3">
                    <ul class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item">Bosse Converted Support List</li>
                    </ul>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex gap-2 flex-wrap">
                    <a href="{{ route('admin.support-bosse-converted-leads.index') }}" class="btn btn-outline-primary active">
...
<div class="row mb-3">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="GET" action="{{ route('admin.support-bosse-converted-leads.index') }}" id="filterForm">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5>Bosse Converted Support List</h5>
            </div>
            <div class="card-body">
                <!-- Desktop Table View -->
                <div class="d-none d-lg-block">
                    <div class="table-responsive">
                        <table class="table table-hover data_table_basic" id="supportBosseTable">
                        <thead>
                            <tr>
                                <th>SL No</th>
...
#supportBosseTable thead th,
#supportBosseTable tbody td {
    white-space: nowrap;
}
...
#supportBosseTable tbody tr:hover {
    background: #fafbff;
}

#supportBosseTable td .display-value {
    display: inline-block;
    max-width: 220px;
    overflow: hidden;
    text-overflow: ellipsis;
...
#supportBosseTable .btn-group .btn { margin-right: 4px; }
#supportBosseTable .btn-group .btn:last-child { margin-right: 0; }
</style>
@endpush
...
<script>
    $(document).ready(function() {
        ...
        $(document).off('click.saveInline').on('click.saveInline', '.save-edit', function(e) {
            ...
            $.ajax({
                url: `/admin/support-bosse-converted-leads/${id}/update-support-details`,
                method: 'POST',
                data: {
                    field: field,
                    value: value,
