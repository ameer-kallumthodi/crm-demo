...
@include('admin.converted-leads.partials.support-flag-inline-scripts', ['supportUpdateUrl' => route('admin.support-nios-converted-leads.update-support-details', ['id' => '__ID__'])])
@endsection
...
<style>
    ...
    #supportNiosTable .btn-group .btn {
        margin-right: 4px;
    }

    #supportNiosTable .btn-group .btn:last-child {
        margin-right: 0;
    }
</style>
@endpush
