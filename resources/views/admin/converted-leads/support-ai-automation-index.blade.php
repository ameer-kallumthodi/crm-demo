            ...
            <div class="card-body">
                ...
                <div class="d-none d-lg-block">
                    <div class="table-responsive">
                        <table class="table table-hover data_table_basic" id="supportAiAutomationTable">
                        <thead>
                            <tr>
                                <th>SL No</th>
...
#supportAiAutomationTable thead th,
#supportAiAutomationTable tbody td {
    white-space: nowrap;
}
...
#supportAiAutomationTable tbody tr:hover {
    background: #fafbff;
}

#supportAiAutomationTable td .display-value {
    display: inline-block;
    max-width: 220px;
    overflow: hidden;
    text-overflow: ellipsis;
...
#supportAiAutomationTable .btn-group .btn { margin-right: 4px; }
#supportAiAutomationTable .btn-group .btn:last-child { margin-right: 0; }
</style>
@endpush
...
<script>
    $(document).ready(function() {
        ...
        function loadSubjectsForEdit($select, currentValue) {
            $.get('/api/subjects/by-course/12').done(function(list) {
