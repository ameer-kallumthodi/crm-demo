        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="page-header-title">
                    <h5 class="m-b-10">Diploma in Data Science Converted Leads Management</h5>
                </div>
            </div>
            <div class="col-md-6">
                <ul class="breadcrumb d-flex justify-content-end">
                    ...
                    <li class="breadcrumb-item">Diploma in Data Science</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex gap-2 flex-wrap">
                    ...
                    <a href="{{ route('admin.diploma-in-data-science-converted-leads.index') }}" class="btn btn-primary active">
...
<div class="row mb-3">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="GET" action="{{ route('admin.diploma-in-data-science-converted-leads.index') }}" id="filterForm">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-12 col-sm-6 col-md-2">
                            ...
                            <a href="{{ route('admin.diploma-in-data-science-converted-leads.index') }}" class="btn btn-secondary">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5>Diploma in Data Science Converted Leads</h5>
            </div>
            <div class="card-body">
                <!-- Desktop Table View -->
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover data_table_basic" id="aiAutomationTable">
                            ...
                            <tbody>
                                ...
                                @empty
                                <tr>
                                    <td colspan="21" class="text-center">No Diploma in Data Science converted leads found</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
                ...
                <div class="d-lg-none">
                    ...
                    <div class="text-center py-5">
                        <div class="text-muted">
                            ...
                            <h5>No Diploma in Data Science converted leads found</h5>
...
<style>
    ...
    #aiAutomationTable .btn-group .btn {
        margin-right: 4px;
    }

    #aiAutomationTable .btn-group .btn:last-child {
        margin-right: 0;
    }
</style>
@endpush
