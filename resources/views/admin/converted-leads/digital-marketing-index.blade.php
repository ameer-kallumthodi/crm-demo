                ...
                <form method="GET" action="{{ route('admin.digital-marketing-converted-leads.index') }}" id="filterForm">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-12 col-sm-6 col-md-2">
                            ...
                            <a href="{{ route('admin.digital-marketing-converted-leads.index') }}" class="btn btn-secondary">
            ...
            <div class="card-body">
                ...
                <div class="d-none d-lg-block">
                    <div class="table-responsive">
                        <table class="table table-hover data_table_basic" id="digitalMarketingTable">
                        <thead>
                            <tr>
                                <th>SL No</th>
                        ...
                        <tbody>
                            ...
                            @empty
                            <tr>
                                <td colspan="19" class="text-center">No Digital Marketing converted leads found</td>
                            </tr>
                            @endforelse
                        </tbody>
                        </table>
...
#digitalMarketingTable .btn-group .btn { margin-right: 4px; }
#digitalMarketingTable .btn-group .btn:last-child { margin-right: 0; }
</style>
@endpush
