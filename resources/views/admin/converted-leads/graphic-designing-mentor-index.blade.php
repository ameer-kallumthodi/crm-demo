...
@section('title', 'Graphic Designing Mentor List')
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="page-header-title">
                    <h5 class="m-b-10">Graphic Designing Mentor List</h5>
                </div>
            </div>
            <div class="col-md-6">
                <ul class="breadcrumb d-flex justify-content-end">
                    ...
                    <li class="breadcrumb-item">Graphic Designing Mentor</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex gap-2 flex-wrap">
                    ...
                    <a href="{{ route('admin.graphic-designing-mentor-converted-leads.index') }}" class="btn btn-outline-primary active">
...
<div class="row mb-3">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="GET" action="{{ route('admin.graphic-designing-mentor-converted-leads.index') }}" id="filterForm">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-12 col-sm-6 col-md-2">
                            ...
                            <a href="{{ route('admin.graphic-designing-mentor-converted-leads.index') }}" class="btn btn-secondary">
...
<div class="row">
    <div class="col-12">
        <div class="card" data-mentor-update-url="{{ route('admin.graphic-designing-mentor-converted-leads.update-mentor-details', ['id' => '__ID__']) }}">
            <div class="card-header">
                <h5>Graphic Designing Mentor List</h5>
            </div>
            <div class="card-body">
                <!-- Desktop Table View -->
                        ...
                        <table class="table table-hover data_table_basic" id="dataScienceMentorTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>Modern AI Tools Session Attendance</th>
                                    ...
                                    <th>Copy Writing Session Attendance</th>
                                    <th>Total Class</th>
                                    <th>Total Present</th>
                                    <th>Total Absent</th>
                                    ...
                                    <th>1st Term Internship Examination Date</th>
                                    <th>Marks</th>
                                    <th>Feedback</th>
                                    <th>Final Internship Certification Examination Date</th>
                                    <th>Marks</th>
                                    <th>Feedback</th>
                            ...
                            <tbody>
                                ...
                                <tr class="{{ $convertedLead->is_cancelled ? 'cancelled-row' : '' }}">
                                    ...
                                    <td>
                                        <div class="inline-edit" data-field="copy_writing_session_attendance" data-id="{{ $convertedLead->id }}" data-current="{{ $convertedLead->mentorDetails?->copy_writing_session_attendance }}">
                                            <span class="display-value">{{ $convertedLead->mentorDetails?->copy_writing_session_attendance ?? '-' }}</span>
                                            @if(\App\Helpers\RoleHelper::is_admin_or_super_admin() || \App\Helpers\RoleHelper::is_admission_counsellor() || \App\Helpers\RoleHelper::is_academic_assistant() || \App\Helpers\RoleHelper::is_hod() || \App\Helpers\RoleHelper::is_mentor())
                                            <button class="btn btn-sm btn-outline-secondary ms-1 edit-btn" title="Edit">
                                                <i class="ti ti-edit"></i>
                                            </button>
                                    ...
                                    <td>
                                        <div class="inline-edit" data-field="first_term_internship_exam_date" data-id="{{ $convertedLead->id }}" data-current="{{ $convertedLead->mentorDetails?->first_term_internship_exam_date ? \Carbon\Carbon::parse($convertedLead->mentorDetails->first_term_internship_exam_date)->format('d-m-Y') : '' }}">
                                            <span class="display-value">{{ $convertedLead->mentorDetails?->first_term_internship_exam_date ? \Carbon\Carbon::parse($convertedLead->mentorDetails->first_term_internship_exam_date)->format('d-m-Y') : '-' }}</span>
                                            @if(\App\Helpers\RoleHelper::is_admin_or_super_admin() || \App\Helpers\RoleHelper::is_admission_counsellor() || \App\Helpers\RoleHelper::is_academic_assistant() || \App\Helpers\RoleHelper::is_hod() || \App\Helpers\RoleHelper::is_mentor())
                                            <button class="btn btn-sm btn-outline-secondary ms-1 edit-btn" title="Edit">
                                                <i class="ti ti-edit"></i>
                                            </button>
                                    ...
                                    <td>
                                        <div class="inline-edit" data-field="first_term_internship_exam_marks" data-id="{{ $convertedLead->id }}" data-current="{{ $convertedLead->mentorDetails?->first_term_internship_exam_marks }}">
                                            <span class="display-value">{{ $convertedLead->mentorDetails?->first_term_internship_exam_marks ?? '-' }}</span>
                                            @if(\App\Helpers\RoleHelper::is_admin_or_super_admin() || \App\Helpers\RoleHelper::is_admission_counsellor() || \App\Helpers\RoleHelper::is_academic_assistant() || \App\Helpers\RoleHelper::is_hod() || \App\Helpers\RoleHelper::is_mentor())
                                            <button class="btn btn-sm btn-outline-secondary ms-1 edit-btn" title="Edit">
                                                <i class="ti ti-edit"></i>
                                            </button>
                                    ...
                                    <td>
                                        <div class="inline-edit" data-field="first_term_internship_exam_feedback" data-id="{{ $convertedLead->id }}" data-current="{{ $convertedLead->mentorDetails?->first_term_internship_exam_feedback }}">
                                            <span class="display-value">{{ $convertedLead->mentorDetails?->first_term_internship_exam_feedback ?? '-' }}</span>
                                            @if(\App\Helpers\RoleHelper::is_admin_or_super_admin() || \App\Helpers\RoleHelper::is_admission_counsellor() || \App\Helpers\RoleHelper::is_academic_assistant() || \App\Helpers\RoleHelper::is_hod() || \App\Helpers\RoleHelper::is_mentor())
                                            <button class="btn btn-sm btn-outline-secondary ms-1 edit-btn" title="Edit">
                                                <i class="ti ti-edit"></i>
                                            </button>
                                    ...
                                    <td>
                                        <div class="inline-edit" data-field="final_internship_certification_exam_date" data-id="{{ $convertedLead->id }}" data-current="{{ $convertedLead->mentorDetails?->final_internship_certification_exam_date ? \Carbon\Carbon::parse($convertedLead->mentorDetails->final_internship_certification_exam_date)->format('d-m-Y') : '' }}">
                                            <span class="display-value">{{ $convertedLead->mentorDetails?->final_internship_certification_exam_date ? \Carbon\Carbon::parse($convertedLead->mentorDetails->final_internship_certification_exam_date)->format('d-m-Y') : '-' }}</span>
                                            @if(\App\Helpers\RoleHelper::is_admin_or_super_admin() || \App\Helpers\RoleHelper::is_admission_counsellor() || \App\Helpers\RoleHelper::is_academic_assistant() || \App\Helpers\RoleHelper::is_hod() || \App\Helpers\RoleHelper::is_mentor())
                                            <button class="btn btn-sm btn-outline-secondary ms-1 edit-btn" title="Edit">
                                                <i class="ti ti-edit"></i>
                                            </button>
                                    ...
                                    <td>
                                        <div class="inline-edit" data-field="final_internship_certification_exam_marks" data-id="{{ $convertedLead->id }}" data-current="{{ $convertedLead->mentorDetails?->final_internship_certification_exam_marks }}">
                                            <span class="display-value">{{ $convertedLead->mentorDetails?->final_internship_certification_exam_marks ?? '-' }}</span>
                                            @if(\App\Helpers\RoleHelper::is_admin_or_super_admin() || \App\Helpers\RoleHelper::is_admission_counsellor() || \App\Helpers\RoleHelper::is_academic_assistant() || \App\Helpers\RoleHelper::is_hod() || \App\Helpers\RoleHelper::is_mentor())
                                            <button class="btn btn-sm btn-outline-secondary ms-1 edit-btn" title="Edit">
                                                <i class="ti ti-edit"></i>
                                            </button>
                                    ...
                                    <td>
                                        <div class="inline-edit" data-field="final_internship_certification_exam_feedback" data-id="{{ $convertedLead->id }}" data-current="{{ $convertedLead->mentorDetails?->final_internship_certification_exam_feedback }}">
                                            <span class="display-value">{{ $convertedLead->mentorDetails?->final_internship_certification_exam_feedback ?? '-' }}</span>
                                            @if(\App\Helpers\RoleHelper::is_admin_or_super_admin() || \App\Helpers\RoleHelper::is_admission_counsellor() || \App\Helpers\RoleHelper::is_academic_assistant() || \App\Helpers\RoleHelper::is_hod() || \App\Helpers\RoleHelper::is_mentor())
                                            <button class="btn btn-sm btn-outline-secondary ms-1 edit-btn" title="Edit">
                                                <i class="ti ti-edit"></i>
                                            </button>
                                    ...
                                    <td>
                                        <div class="inline-edit" data-field="completed_cancelled_date" data-id="{{ $convertedLead->id }}" data-current="{{ $convertedLead->mentorDetails?->completed_cancelled_date ? \Carbon\Carbon::parse($convertedLead->mentorDetails->completed_cancelled_date)->format('d-m-Y') : '' }}">
                                            <span class="display-value">{{ $convertedLead->mentorDetails?->completed_cancelled_date ? \Carbon\Carbon::parse($convertedLead->mentorDetails->completed_cancelled_date)->format('d-m-Y') : '-' }}</span>
                                            @if(\App\Helpers\RoleHelper::is_admin_or_super_admin() || \App\Helpers\RoleHelper::is_admission_counsellor() || \App\Helpers\RoleHelper::is_academic_assistant() || \App\Helpers\RoleHelper::is_hod() || \App\Helpers\RoleHelper::is_mentor())
                                            <button class="btn btn-sm btn-outline-secondary ms-1 edit-btn" title="Edit">
                                                <i class="ti ti-edit"></i>
                                            </button>
                                ...
                                @empty
                                <tr>
                                    <td colspan="66" class="text-center">No Graphic Designing mentor records found</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
                ...
                <div class="d-lg-none">
                    ...
                    <div class="text-center py-5">
                        <div class="text-muted">
                            ...
                            <h5>No Graphic Designing mentor records found</h5>
    ...
    $(document).ready(function() {
        ...
        $(document).off('click.saveInline').on('click.saveInline', '.save-edit', function(e) {
            ...
            const updateUrl = isConvertedLeadField ?
                ...
                `/admin/graphic-designing-mentor-converted-leads/${id}/update-mentor-details`;
        ...
        function createSelectField(field, currentValue) {
            ...
            if (field === 'call_status') {
                ...
                options = `
                    <option value="">Select Modern AI Tools Session Attendance</option>
                ...
                `;
            } else if (field === 'copy_writing_session_attendance') {
                options = `
                    <option value="">Select Copy Writing Session Attendance</option>
                    <option value="Attended" ${currentValue === 'Attended' ? 'selected' : ''}>Attended</option>
                    <option value="Not Attended" ${currentValue === 'Not Attended' ? 'selected' : ''}>Not Attended</option>
                `;
            }
