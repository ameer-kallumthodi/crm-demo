                    ...
                    <div class="col-lg-4">
                        <div class="card shadow-none border h-100">
                            <div class="card-body">
                                ...
                                <div class="mt-2"><span class="text-muted">Type:</span> <span class="fw-medium">{{ $convertedLead->is_b2b == 1 ? ('B2B' . ($convertedLead->lead?->team?->name ? ' (' . $convertedLead->lead->team->name . ')' : '')) : 'In House' }}</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
