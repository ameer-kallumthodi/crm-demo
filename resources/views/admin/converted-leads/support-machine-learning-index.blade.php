...
@section('title', 'Diploma in Machine Learning Converted Support List')
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="page-header-title">
                    <h5 class="m-b-10">Diploma in Machine Learning Converted Support List</h5>
                </div>
            </div>
            <div class="col-md-6">
                <div class="d-flex justify-content-end align-items-center gap-3">
                    <ul class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item">Diploma in Machine Learning Converted Support List</li>
                    </ul>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex gap-2 flex-wrap">
                    ...
                    <a href="{{ route('admin.support-machine-learning-converted-leads.index') }}" class="btn btn-outline-primary active">
...
<div class="row mb-3">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="GET" action="{{ route('admin.support-machine-learning-converted-leads.index') }}" id="filterForm">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-12 col-sm-6 col-md-2">
                            ...
                            <a href="{{ route('admin.support-machine-learning-converted-leads.index') }}" class="btn btn-secondary">
...
@include('admin.converted-leads.partials.support-flag-inline-scripts', ['supportUpdateUrl' => route('admin.support-machine-learning-converted-leads.update-support-details', ['id' => '__ID__'])])
@endsection
...
<style>
    ...
    #supportGraphicDesigningTable .btn-group .btn {
        margin-right: 4px;
    }

    #supportGraphicDesigningTable .btn-group .btn:last-child {
        margin-right: 0;
    }
</style>
@endpush
