...
@section('title', 'Junior Vlogger Converted Faculty List')
...
$canEdit = \App\Helpers\RoleHelper::is_admin_or_super_admin() || \App\Helpers\RoleHelper::is_admission_counsellor() || \App\Helpers\RoleHelper::is_academic_assistant() || \App\Helpers\RoleHelper::is_hod() || \App\Helpers\RoleHelper::is_faculty();
@endphp
<style>
    .table td {
        white-space: nowrap;
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="page-header-title">
                    <h5 class="m-b-10">Junior Vlogger Converted Faculty List</h5>
                </div>
            </div>
            <div class="col-md-6">
                <ul class="breadcrumb d-flex justify-content-end">
                    ...
                    <li class="breadcrumb-item">Junior Vlogger Faculty</li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="row mb-3">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="GET" action="{{ route('admin.junior-vlogger-faculty-converted-leads.index') }}" id="filterForm">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-12 col-sm-6 col-md-2">
                            ...
                            <a href="{{ route('admin.junior-vlogger-faculty-converted-leads.index') }}" class="btn btn-secondary"><i class="ti ti-x"></i> Clear</a>
                        </div>
                    </div>
                </form>
            </div>
...
<div class="row">
    <div class="col-12">
        <div class="card" data-mentor-update-url="{{ route('admin.junior-vlogger-faculty-converted-leads.update-mentor-details', ['id' => '__ID__']) }}">
            <div class="card-header">
                <h5 class="mb-0">Junior Vlogger Converted Faculty List</h5>
            </div>
            <div class="card-body">
                <!-- Desktop Table View -->
...
$(document).ready(function() {
    ...
    var updateUrlBase = '{{ route("admin.junior-vlogger-faculty-converted-leads.update-mentor-details", ":id") }}';
...
@include('admin.converted-leads.partials.course-flag-inline-scripts', ['courseUpdateUrl' => route('admin.junior-vlogger-faculty-converted-leads.update-mentor-details', ['id' => '__ID__'])])
@endpush