...
@section('title', 'Bosse Converted Faculty List')
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="page-header-title">
                    <h5 class="m-b-10">Bosse Converted Faculty List</h5>
                </div>
            </div>
            <div class="col-md-6">
                <div class="d-flex justify-content-end align-items-center gap-3">
                    <ul class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item">Bosse Converted Faculty List</li>
                    </ul>
...
<div class="row mb-3">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="GET" action="{{ route('admin.faculty-bosse-converted-leads.index') }}" id="filterForm">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-12 col-sm-6 col-md-2">
                            ...
                            <a href="{{ route('admin.faculty-bosse-converted-leads.index') }}" class="btn btn-secondary">
...
<div class="row">
    <div class="col-12">
        <div class="card" data-mentor-update-url="{{ route('admin.faculty-bosse-converted-leads.update-mentor-details', ['id' => '__ID__']) }}">
            <div class="card-header">
                <h5>Bosse Converted Faculty List</h5>
            </div>
            <div class="card-body">
                <!-- Desktop Table View -->
                        ...
                        <table class="table table-hover data_table_basic" id="mentorBosseTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>Problems</th>
                                    <th>CALL - 2</th>
                                    <th>Faculty Live 1</th>
                                    <th>FIRST LIVE</th>
                                    <th>FIRST EXAM Registration</th>
                                    <th>FIRST EXAM</th>
                                    <th>CALL - 3</th>
                                    <th>Faculty Live 2</th>
                                    <th>SECOND LIVE</th>
                                    <th>Second Exam</th>
                                    <th>CALL - 4</th>
                                    <th>Faculty Live 3</th>
                                    <th>Model Exam Live</th>
                                    <th>Model Exam</th>
                                    <th>Practical</th>
                                    <th>CALL - 5</th>
                                    <th>Faculty Live 4</th>
                            ...
                            <tbody>
                                @forelse($convertedLeads as $index => $convertedLead)
                                    @include('admin.converted-leads.partials.faculty-bosse-dt-desktop-row')
                                @empty
                                <tr>
                ...
                <div class="d-lg-none" id="mentorBosseMobileCardsWrap">
                    ...
                    @include('admin.converted-leads.partials.faculty-bosse-mobile-card')
                    @empty
...
<script>
    $(document).ready(function() {
        ...
        $(document).off('click.saveInline').on('click.saveInline', '.save-edit', function(e) {
            ...
            $.ajax({
                url: `/admin/faculty-bosse-converted-leads/${id}/update-mentor-details`,
                method: 'POST',
                data: {
                    field: field,
                    value: value,
        ...
        function createSelectField(field, currentValue) {
            ...
            if (field === 'registration_status') {
                ...
                options = `
                    <option value="">Select Faculty Live Status</option>
                    <option value="Not Respond" ${currentValue === 'Not Respond' ? 'selected' : ''}>Not Respond</option>
                    <option value="Task Complete" ${currentValue === 'Task Complete' ? 'selected' : ''}>Task Complete</option>
                `;
...
@include('admin.converted-leads.partials.course-flag-inline-scripts', ['courseUpdateUrl' => route('admin.faculty-bosse-converted-leads.update-mentor-details', ['id' => '__ID__'])])
@endpush
