<form action="{{ route('admin.leads.pullback.submit') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="row g-3">
        <div class="col-lg-3">
            <div class="p-1">
        ...
        <div class="col-lg-12 pt-2">
            <div class="d-flex justify-content-between align-items-center">
                <label class="mb-0">Select Leads to Pullback</label>
        ...
        <div class="col-12 p-2">
            <button class="btn btn-danger float-end" type="submit" id="pullback_btn" disabled>Pullback</button>
        </div>
    </div>
</form>
...
<script>
    $(document).ready(function() {
        ...
        function fetchLeadsForPullback() {
            ...
            if (telecallerId && leadSourceId && leadStatusId && fromDate && toDate) {
                $.ajax({
                    url: '{{ route("admin.leads.get-pullback-leads") }}',
                    type: 'POST',
                    data: {
                    ...
                    error: function(xhr) {
                        console.log('Error fetching pullback leads:', xhr.responseText);
                        $leadTableBody.html('');
                        toggleSubmitButton();
                    }
                });
        ...
        $('#telecaller_id, #lead_source_id, #lead_status_id, #lead_from_date, #lead_to_date').on('change', fetchLeadsForPullback);
    });
</script>
