    ...
    <div class="row g-3">
        ...
        <div class="col-lg-6">
            <div class="p-1">
                ...
                <div class="input-group">
                    <span class="input-group-text">₹</span>
                    <input type="number" step="0.01" min="0" class="form-control" name="b2b_amount" id="b2b_amount" value="{{ old('b2b_amount', $edit_data->b2b_amount) }}" placeholder="Enter B2B amount">
                </div>
            </div>
        </div>
