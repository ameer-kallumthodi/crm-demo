<div class="container p-2">
    <form id="departmentAddForm" action="{{ route('admin.departments.submit') }}" method="post">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="mb-3">
                    <label class="form-label" for="title">Department Title <span class="text-danger">*</span></label>
                    <input type="text" name="title" class="form-control" id="title" placeholder="Enter Department Title" required>
                </div>
            </div>
    ...
    $('#departmentAddForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                toast_success('Department created successfully!');
