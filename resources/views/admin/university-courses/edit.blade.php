<div class="container p-2">
    ...
    <form id="universityCourseEditForm" action="{{ route('admin.university-courses.update', $edit_data->id) }}" method="post">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <select name="university_id" class="form-control" id="university_id" required>
                        ...
                        @foreach($universities as $university)
                            <option value="{{ $university->id }}" {{ $edit_data->university_id == $university->id ? 'selected' : '' }}>
                                {{ $university->title }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <select name="course_type" class="form-control" id="course_type">
                        ...
                        <option value="UG" {{ $edit_data->course_type == 'UG' ? 'selected' : '' }}>UG (Undergraduate)</option>
                        <option value="PG" {{ $edit_data->course_type == 'PG' ? 'selected' : '' }}>PG (Postgraduate)</option>
                    </select>
            ...
            <div class="col-md-12">
                <div class="mb-3">
                    ...
                    <textarea name="description" class="form-control" 
                              id="description" rows="3" placeholder="Enter Course Description">{{ $edit_data->description }}</textarea>
    ...
    $(document).ready(function() {
        $('#universityCourseEditForm').on('submit', function(e) {
            e.preventDefault();
