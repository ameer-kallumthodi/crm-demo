...
<head>
    ...
    <title>Eduthanzeel Course Registration</title>
...
<body style="background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%); min-height: 100vh; padding: 20px 0;">
    <div class="wizard-container">
        <div class="wizard-header">
            <div class="logo-container mb-3">
                <img src="{{ asset('eduthanzeel.png') }}" alt="Eduthanzeel Logo" class="eduthanzeel-logo">
            </div>
            <h2><i class="fas fa-book me-2"></i>Eduthanzeel Course Registration</h2>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
     <script>
         let currentStep = 1;
         const totalSteps = 3;
         const STORAGE_KEY = 'eduthanzeel_form_data';
        ...
        document.getElementById('registrationForm').addEventListener('submit', function(e) {
            ...
            fetch('{{ route("public.lead.eduthanzeel.register.store") }}', {
                method: 'POST',
                body: formData,
                headers: {
