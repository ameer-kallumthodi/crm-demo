...
<body style="background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%); min-height: 100vh; padding: 20px 0;">
    <div class="wizard-container">
        <div class="wizard-header">
            ...
            <h2><i class="fas fa-graduation-cap me-2"></i>RPA Registration</h2>
    ...
    <script>
        let currentStep = 1;
        const totalSteps = 3;
        const STORAGE_KEY = 'rpa_registration_form_data';
        ...
        function setupFileUploadHandlers() {
            const fileInputs = [
                ...
                'sslc_certificate', 'other_relevant_documents'
            ];
        ...
        function validateStep(step) {
            ...
            if (step === 3) {
                ...
                const requiredFileFields = ['passport_photo', 'adhar_front', 'adhar_back', 'signature', 'sslc_certificate'];
        ...
        document.getElementById('registrationForm').addEventListener('submit', function(e) {
            ...
            if (!termsCb || !termsCb.checked) {
                showAlert('Please read and accept the Terms and Conditions.', 'warning');
                return;
            }
            ...
            submitBtn.classList.add('loading');
                    ...
                    fetch('{{ route("public.lead.rpa.register.store") }}', {
                method: 'POST',
                body: formData,
                headers: {
