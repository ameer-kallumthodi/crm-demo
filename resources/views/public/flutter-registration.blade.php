...
<head>
    ...
    <title>Flutter Registration</title>
...
<body style="background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%); min-height: 100vh; padding: 20px 0;">
    <div class="wizard-container">
        <div class="wizard-header">
            ...
            <h2><i class="fas fa-graduation-cap me-2"></i>Flutter Registration</h2>
    ...
    <script>
        let currentStep = 1;
        const totalSteps = 4;
        const STORAGE_KEY = 'flutter_form_data';
        ...
        document.getElementById('registrationForm').addEventListener('submit', function(e) {
            ...
            submitBtn.classList.add('loading');
                    ...
                    fetch('{{ route("public.lead.flutter.register.store") }}', {
                method: 'POST',
                body: formData,
                headers: {
