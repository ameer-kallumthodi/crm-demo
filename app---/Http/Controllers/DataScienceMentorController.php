...
class DataScienceMentorController extends Controller
{
    /**
     * Display a listing of Data Science converted leads for mentoring
     */
    public function index(Request $request)
    {
        ...
        if ($currentUser) {
            if (RoleHelper::is_admin_or_super_admin()) {
                ...
                // Check if current course (12) is in HOD's assigned courses
                if (!empty($hodCourseIds) && in_array(12, $hodCourseIds)) {
        ...
        // Get filter data
        $batches = Batch::where('course_id', 12)->orderBy('title')->get();
    ...
    private function getValidationRules($field)
    {
        $rules = [
            ...
            'data_science_workshop_attendance' => 'nullable|in:Attended,Not Attended',
