...
class LeadMedicalCodingRegistrationController extends Controller
{
    public function showMedicalCodingForm($leadId = null)
    {
        ...
        if ($leadId) {
            ...
            if ($lead && $lead->medicalCodingStudentDetails) {
        ...
        return view('public.medical-coding-registration', compact('subjects', 'batches', 'lead', 'countryCodes', 'course', 'classTimes', 'offlinePlaces'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return response()->json([
                ...
                'data' => $studentDetail,
                'redirect' => route('public.lead.medical-coding.register.success', $request->lead_id)
            ]);
