...
class BosseRegistrationController extends Controller
{
    public function showBosseForm($convertedLeadId = null)
    {
        ...
        if ($convertedLeadId) {
            ...
            // Check if student has already registered for BOSSE
            if ($convertedLead && $convertedLead->bosseStudentDetails) {
                return view('public.bosse-registration-success');
            }
        }
        ...
        return view('public.bosse-registration', compact('subjects', 'batches', 'convertedLead', 'countryCodes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // Create student detail record for BOSSE
            $studentDetail = ConvertedStudentDetail::create([
                ...
                'status' => 'pending',
                'course_type' => 'bosse', // Add course type to distinguish BOSSE from NIOS
            ]);
            ...
            return response()->json([
                ...
                'data' => $studentDetail,
                'redirect' => route('public.bosse.register', $request->converted_lead_id)
            ]);
